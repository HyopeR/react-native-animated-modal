...
export const LegendListPage = ({back}: PageProps) => {
  ...
  const ref = useRef<ScrollableLegendListNs.Ref>(null);

  return (
    <Screen scrollable={true}>
      <Screen.Header left={'Back'} leftProps={{onPress: back}}>
        <Screen.Title>LegendList Playground</Screen.Title>
      </Screen.Header>

      <Screen.Content style={PageStyle.root}>
        <View style={PageStyle.body}>
          <Text style={PageStyle.description}>
            If you have installed @legendapp/list in your project, you can use
            the ScrollableLegendList component.
          </Text>
      ...
      <Modal
        ...
        <View
          ...
          <View style={ModalStyle.body}>
            <Text style={ModalStyle.title}>LegendList Example</Text>
            {!landscape && (
