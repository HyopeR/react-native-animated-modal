...
export const FlashListPage = ({back}: PageProps) => {
  ...
  const ref = useRef<ScrollableFlashListNs.Ref<number>>(null);

  return (
    <Screen scrollable={true}>
      <Screen.Header left={'Back'} leftProps={{onPress: back}}>
        <Screen.Title>FlashList Playground</Screen.Title>
      </Screen.Header>

      <Screen.Content style={PageStyle.root}>
        <View style={PageStyle.body}>
          <Text style={PageStyle.description}>
            If you have installed @shopify/flash-list in your project, you can
            use the ScrollableFlashList component.
          </Text>
      ...
      <Modal
        ...
        <View
          ...
          <View style={ModalStyle.body}>
            <Text style={ModalStyle.title}>FlashList Example</Text>
            {!landscape && (
